...
import { createAndUpdateCourseHandler , createCourseSectionHandler , createCourseSubSectionHandler , showallCoursesHandler , getSingleCourseHandler ,getDraftCourseHandler , publishCourseHandler , getCourseSubSectionHandler , deleteDraftCourseHandler } from '../controllers/courseController';
...
courseRouter.get('/draft-course' , userAuth , isInstructor ,  getDraftCourseHandler);
...
courseRouter.delete('/delete-draft-course', userAuth , isInstructor , deleteDraftCourseHandler);
