...
const InputFieldVarient : any = {
    Primary : "bg-gray-50 border-0 border-b-2 border-white text-gray-900 text-xl rounded-lg  focus:ring-0 focus:border-white block w-full p-2.5 dark:bg-gray-700 dark:border-b-2 dark:border-white dark:placeholder-gray-400 dark:text-white dark:focus:ring-0 dark:focus:border-white",
